//https://api.aladhan.com/v1/calendarByCity?city=Paris&country=France&method=2&month=09&year=2021//
//https://api.aladhan.com/v1/timingsByAddress?address=France,%20UK&method=99&methodSettings=18.5,null,17.5&tune=1,2,3,4,5
//http://api.aladhan.com/v1/timingsByCity?city=Paris&country=France&method=8

// let cards = document.querySelector(".cards");
// let myHorloge = document.querySelector("#date");
...
//       for (let horairePriere in nomPriere) {
//         //console.log(time)   // récupéraion noms de prieres
//         //console.log(times[time]);    // récupération des horaires de prieres

//         cards.innerHTML += `
//         <div class="cards">
//         <div class="horaire-priere">
//            <span class="namee-priere">${nomPriere[horairePriere]} </span>
//           <span class="time-priere">${horairePriere}</span>
...
//   setTimeout(heureTime, 1000);
// }
// heureTime();

// FIN DE LA DEUXIEME METHODE *********************************************************************************/

//*************************************************************************************************************/


// let startHors = 7;
//   let time = startHors * 60
// const comptDown = document.getElementById("compteur-salate");
...
//     comptDown.innerHTML = ` salate fajr dans ${hours} : ${minutes}`;
//    if(time > 0) {
//     time--;
//    } else {
...
// updateTime ()
// const mawakite = async () => {
//   await fetch(
//     "http://api.aladhan.com/v1/timingsByCity?city=Paris&country=France&method=8"
//   )
//     .then((res) => res.json())
//     .then((data) => (elMawakites = data.data));

//   console.log(elMawakites);
// };
// const displayMawakit = async () => {
//   await mawakite();

//   document.body.innerHTML = elMawakites
//     .map(
//       (horaire) =>
//         `
//         <div class= "horloge">
//         <div class="date">
//         <span> ${horaire.date.readable} </span>
//         </div>
//         </div>
...
//         <div class="fajr">
//       <span> Fajr </span>
//       <span> ${horaire.timing.Fajr}</span>
//       </div>
//       <div class="dhuhr">
//       <span> Dhuhr </span>
//       <span> ${horaire.timings}</span>
//       </div>
//       <div class="asr">
//       <span> Asr </span>
//       <span> ${horaire.timings}</span>
